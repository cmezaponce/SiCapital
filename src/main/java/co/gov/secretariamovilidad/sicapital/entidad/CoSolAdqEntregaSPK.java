 ...
 */
@Embeddable
public class CoSolAdqEntregaSPK implements Serializable {
    ...
    public CoSolAdqEntregaSPK() {
    }

    public CoSolAdqEntregaSPK(short vigencia, int numSolAdq, short numEntrega, long id, short consecutivo, short item) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CoSolAdqEntregaSPK)) {
            return false;
        }
        CoSolAdqEntregaSPK other = (CoSolAdqEntregaSPK) object;
    ...
    public String toString() {
        return "co.gov.secretariamovilidad.sicapital.entidad.CoSolAdqEntregaSPK[ vigencia=" + vigencia + ", numSolAdq=" + numSolAdq + ", numEntrega=" + numEntrega + ", id=" + id + ", consecutivo=" + consecutivo + ", item=" + item + " ]";
    }
