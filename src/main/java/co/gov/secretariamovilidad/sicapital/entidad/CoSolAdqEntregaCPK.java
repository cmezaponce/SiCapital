 ...
 */
@Embeddable
public class CoSolAdqEntregaCPK implements Serializable {
    ...
    public CoSolAdqEntregaCPK() {
    }

    public CoSolAdqEntregaCPK(short vigencia, int numSolAdq, short numEntrega, long id, short consecutivo, short item) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CoSolAdqEntregaCPK)) {
            return false;
        }
        CoSolAdqEntregaCPK other = (CoSolAdqEntregaCPK) object;
    ...
    public String toString() {
        return "co.gov.secretariamovilidad.sicapital.entidad.CoSolAdqEntregaCPK[ vigencia=" + vigencia + ", numSolAdq=" + numSolAdq + ", numEntrega=" + numEntrega + ", id=" + id + ", consecutivo=" + consecutivo + ", item=" + item + " ]";
    }
