 ...
 */
@Embeddable
public class CoDtlleSolAdqCPK implements Serializable {
    ...
    public CoDtlleSolAdqCPK() {
    }

    public CoDtlleSolAdqCPK(short vigencia, int numSolAdq, long id, short consecutivo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CoDtlleSolAdqCPK)) {
            return false;
        }
        CoDtlleSolAdqCPK other = (CoDtlleSolAdqCPK) object;
    ...
    public String toString() {
        return "co.gov.secretariamovilidad.sicapital.entidad.CoDtlleSolAdqCPK[ vigencia=" + vigencia + ", numSolAdq=" + numSolAdq + ", id=" + id + ", consecutivo=" + consecutivo + " ]";
    }
