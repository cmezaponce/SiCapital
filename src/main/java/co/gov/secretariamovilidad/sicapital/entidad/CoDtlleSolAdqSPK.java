 ...
 */
@Embeddable
public class CoDtlleSolAdqSPK implements Serializable {
    ...
    public CoDtlleSolAdqSPK() {
    }

    public CoDtlleSolAdqSPK(short vigencia, int numSolAdq, long id, short consecutivo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CoDtlleSolAdqSPK)) {
            return false;
        }
        CoDtlleSolAdqSPK other = (CoDtlleSolAdqSPK) object;
    ...
    public String toString() {
        return "co.gov.secretariamovilidad.sicapital.entidad.CoDtlleSolAdqSPK[ vigencia=" + vigencia + ", numSolAdq=" + numSolAdq + ", id=" + id + ", consecutivo=" + consecutivo + " ]";
    }
