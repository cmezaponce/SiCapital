 ...
 */
@Embeddable
public class CoSolAdqCarCPK implements Serializable {
    ...
    public CoSolAdqCarCPK() {
    }

    public CoSolAdqCarCPK(short vigencia, int numSolAdq, long id, short consecutivo, String caracteristica) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CoSolAdqCarCPK)) {
            return false;
        }
        CoSolAdqCarCPK other = (CoSolAdqCarCPK) object;
    ...
    public String toString() {
        return "co.gov.secretariamovilidad.sicapital.entidad.CoSolAdqCarCPK[ vigencia=" + vigencia + ", numSolAdq=" + numSolAdq + ", id=" + id + ", consecutivo=" + consecutivo + ", caracteristica=" + caracteristica + " ]";
    }
